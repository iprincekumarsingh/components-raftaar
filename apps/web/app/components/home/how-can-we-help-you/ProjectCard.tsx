...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="w-full flex-col og mx-2 justify-center items-center gap-5 inline-flex py-10">
      <img
        className="w-[370px] lg:w-[1253px] h-[301px] lg:h-[602px] relative"
        src={image}
        alt={projectName}
      />
      <div className="w-[380px] self-stretch flex-col justify-start items-start flex">
